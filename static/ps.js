...
(function($PS) {
  "use strict";
  $PS["App.TaskList"] = $PS["App.TaskList"] || {};
  var exports = $PS["App.TaskList"];
  ...
  var CompletionDate = (function () {
      function CompletionDate() {

      };
      CompletionDate.value = new CompletionDate();
  ...
  var DueDate = (function () {
      ...
      DueDate.value = new DueDate();
      return DueDate;
  })();
  var ByUnitOfTime = (function () {
      function ByUnitOfTime(value0, value1, value2) {
          this.value0 = value0;
          this.value1 = value1;
          this.value2 = value2;
      };
      ByUnitOfTime.create = function (value0) {
          return function (value1) {
              return function (value2) {
                  return new ByUnitOfTime(value0, value1, value2);
              };
          };
      };
      return ByUnitOfTime;
  })();
  var OnWeekdays = (function () {
      function OnWeekdays(value0) {
          this.value0 = value0;
      };
      OnWeekdays.create = function (value0) {
          return new OnWeekdays(value0);
      };
      return OnWeekdays;
  })();
  var None = (function () {
  ...
  var LoadTasks = (function () {
      function LoadTasks(value0) {
          this.value0 = value0;
      };
      LoadTasks.create = function (value0) {
          return new LoadTasks(value0);
      };
      return LoadTasks;
  })();
  var showDateTime = Data_DateTime.showDateTime;
  var showDate = Data_Date.showDate;
  var reset = function (v) {
      return {
          tasks: Data_Maybe.Nothing.value
      };
  };
  var render = function (state) {
      var manageIcon = function (title) {
  ...
  var genericUnitOfTime = new Data_Generic_Rep.Generic(function (x) {
      if (x instanceof Days) {
          return new Data_Generic_Rep.Inl(Data_Generic_Rep.NoArguments.value);
      };
      if (x instanceof Weeks) {
          return new Data_Generic_Rep.Inr(new Data_Generic_Rep.Inl(Data_Generic_Rep.NoArguments.value));
      };
      if (x instanceof Months) {
          return new Data_Generic_Rep.Inr(new Data_Generic_Rep.Inr(new Data_Generic_Rep.Inl(Data_Generic_Rep.NoArguments.value)));
      };
  ...
  var genericRepeatInterval = new Data_Generic_Rep.Generic(function (x) {
      if (x instanceof ByUnitOfTime) {
  ...
  var showRepeatInterval = new Data_Show.Show(Data_Generic_Rep_Show.genericShow(genericRepeatInterval)(Data_Generic_Rep_Show.genericShowSum(Data_Generic_Rep_Show.genericShowConstructor(Data_Generic_Rep_Show.genericShowArgsProduct(Data_Generic_Rep_Show.genericShowArgsArgument(showUnitOfTime))(Data_Generic_Rep_Show.genericShowArgsProduct(Data_Generic_Rep_Show.genericShowArgsArgument(Data_Show.showInt))(Data_Generic_Rep_Show.genericShowArgsArgument(showRepeatFrom))))(new Data_Symbol.IsSymbol(function () {
      return "ByUnitOfTime";
  })))(Data_Generic_Rep_Show.genericShowConstructor(Data_Generic_Rep_Show.genericShowArgsArgument(Data_Show.showArray(showWeekday)))(new Data_Symbol.IsSymbol(function () {
      return "OnWeekdays";
  })))));
  var genericPriority = new Data_Generic_Rep.Generic(function (x) {
  ...
  var decodeJsonWeekday = new Data_Argonaut_Decode_Class.DecodeJson(Data_Argonaut_Decode_Generic_Rep.genericDecodeJson(genericWeekday)(Data_Argonaut_Decode_Generic_Rep.decodeRepSum(Data_Argonaut_Decode_Generic_Rep.decodeRepConstructorNoArgs(new Data_Symbol.IsSymbol(function () {
      return "Monday";
  ...
  var decodeJsonUnitOfTime = new Data_Argonaut_Decode_Class.DecodeJson(Data_Argonaut_Decode_Generic_Rep.genericDecodeJson(genericUnitOfTime)(Data_Argonaut_Decode_Generic_Rep.decodeRepSum(Data_Argonaut_Decode_Generic_Rep.decodeRepConstructorNoArgs(new Data_Symbol.IsSymbol(function () {
      return "Days";
  })))(Data_Argonaut_Decode_Generic_Rep.decodeRepSum(Data_Argonaut_Decode_Generic_Rep.decodeRepConstructorNoArgs(new Data_Symbol.IsSymbol(function () {
      return "Weeks";
  })))(Data_Argonaut_Decode_Generic_Rep.decodeRepSum(Data_Argonaut_Decode_Generic_Rep.decodeRepConstructorNoArgs(new Data_Symbol.IsSymbol(function () {
  ...
  var decodeJsonRepeatFrom = new Data_Argonaut_Decode_Class.DecodeJson(Data_Argonaut_Decode_Generic_Rep.genericDecodeJson(genericRepeatFrom)(Data_Argonaut_Decode_Generic_Rep.decodeRepSum(Data_Argonaut_Decode_Generic_Rep.decodeRepConstructorNoArgs(new Data_Symbol.IsSymbol(function () {
      return "CompletionDate";
  })))(Data_Argonaut_Decode_Generic_Rep.decodeRepConstructorNoArgs(new Data_Symbol.IsSymbol(function () {
      return "DueDate";
  })))));
  var decodeJsonRepeatInterval = new Data_Argonaut_Decode_Class.DecodeJson(Data_Argonaut_Decode_Generic_Rep.genericDecodeJson(genericRepeatInterval)(Data_Argonaut_Decode_Generic_Rep.decodeRepSum(Data_Argonaut_Decode_Generic_Rep.decodeRepConstructor(new Data_Symbol.IsSymbol(function () {
      return "ByUnitOfTime";
  }))(Data_Argonaut_Decode_Generic_Rep.decodeRepArgsProduct(Data_Argonaut_Decode_Generic_Rep.decodeRepArgsArgument(decodeJsonUnitOfTime))(Data_Argonaut_Decode_Generic_Rep.decodeRepArgsProduct(Data_Argonaut_Decode_Generic_Rep.decodeRepArgsArgument(Data_Argonaut_Decode_Class.decodeJsonInt))(Data_Argonaut_Decode_Generic_Rep.decodeRepArgsArgument(decodeJsonRepeatFrom)))))(Data_Argonaut_Decode_Generic_Rep.decodeRepConstructorArg(new Data_Symbol.IsSymbol(function () {
      return "OnWeekdays";
  }))(Data_Argonaut_Decode_Class.decodeArray(decodeJsonWeekday)))));
  var decodeJsonPriority = new Data_Argonaut_Decode_Class.DecodeJson(function (v) {
      return new Data_Either.Right(High.value);
  });
  var decodeJsonDateTime = new Data_Argonaut_Decode_Class.DecodeJson((function () {
...
(function($PS) {
  ...
  $PS["Main"] = $PS["Main"] || {};
  var exports = $PS["Main"];
  var App_TaskList = $PS["App.TaskList"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Data_Functor = $PS["Data.Functor"];
  var Data_Maybe = $PS["Data.Maybe"];
  ...
  var taskList = function (selector) {
      return Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.selectElement(selector))(function (element) {
          if (element instanceof Data_Maybe.Just) {
              return Data_Functor["void"](Effect_Aff.functorAff)(Halogen_VDom_Driver.runUI(App_TaskList.component(Effect_Aff_Class.monadAffAff))(Data_Unit.unit)(element.value0));
          };
          if (element instanceof Data_Maybe.Nothing) {
              return Control_Applicative.pure(Effect_Aff.applicativeAff)(Data_Unit.unit);
          };
          throw new Error("Failed pattern match at Main (line 15, column 3 - line 17, column 25): " + [ element.constructor.name ]);
      });
  };
  var main = Halogen_Aff_Util.runHalogenAff(taskList("#psTaskList"));
