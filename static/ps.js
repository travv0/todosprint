...
(function($PS) {
  ...
  var taskList = function (v) {
      return Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.selectElement(v))(function (element) {
          ...
          throw new Error("Failed pattern match at Main (line 15, column 5 - line 17, column 27): " + [ element.constructor.name ]);
      }));
  };
