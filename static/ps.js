  ...
  var render = function (state) {
      var manageIcon = function (title) {
          return function (glyphicon) {
              return Halogen_HTML_Elements.a([ Halogen_HTML_Properties.attr("class")("manageIcon"), Halogen_HTML_Properties.attr("href")("#"), Halogen_HTML_Properties.attr("title")(title) ])([ Halogen_HTML_Elements.span([ Halogen_HTML_Properties.attr("class")("glyphicon glyphicon-" + glyphicon), Halogen_HTML_Properties.attr("aria-hidden")("true") ])([  ]) ]);
          };
      };
      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.attr("class")("tasksDiv") ])([ Halogen_HTML_Elements.h4([ Halogen_HTML_Properties.attr("class")("taskListHeader") ])([ Halogen_HTML_Core.text("Today's To-Dos") ]), Halogen_HTML_Elements.table([ Halogen_HTML_Properties.attr("class")("taskList") ])(Data_Function.flip(Data_Functor.map(Data_Functor.functorArray))(Data_Array.range(0)(3))(function (v) {
          return Halogen_HTML_Elements.tr([ Halogen_HTML_Properties.attr("class")("task") ])([ Halogen_HTML_Elements.td([ Halogen_HTML_Properties.attr("class")("taskCheckbox") ])([ Halogen_HTML_Elements.form([ Halogen_HTML_Properties.attr("action")("/mark-done/#"), Halogen_HTML_Properties.attr("method")("post") ])([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.attr("href")("javascript:;"), Halogen_HTML_Properties.attr("title")("Complete task"), Halogen_HTML_Properties.attr("onclick")("this.parentNode.submit();") ])([ Halogen_HTML_Elements.span([ Halogen_HTML_Properties.attr("class")("glyphicon glyphicon-unchecked"), Halogen_HTML_Properties.attr("aria-hidden")("true") ])([  ]) ]) ]) ]), Halogen_HTML_Elements.td([ Halogen_HTML_Properties.attr("class")("taskInfo"), Halogen_HTML_Properties.attr("id")("task-#") ])([ Halogen_HTML_Elements.span([ Halogen_HTML_Properties.attr("class")("taskNameAndDuration") ])([ Halogen_HTML_Elements.span([ Halogen_HTML_Properties.attr("class")("taskName") ])([ Halogen_HTML_Core.text("Task Name") ]) ]) ]), Halogen_HTML_Elements.td([ Halogen_HTML_Properties.attr("class")("taskManagement") ])([ manageIcon("Edit task")("pencil"), manageIcon("Postpone task")("calendar"), manageIcon("Delete task")("remove") ]) ]);
      })) ]);
  };
  var handleAction = function (v) {
      ...
      if (v instanceof Decrement) {
          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
              ...
              $10.count = st.count - 1 | 0;
              return $10;
          });
      };
      if (v instanceof Reset) {
          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(reset);
      };
      throw new Error("Failed pattern match at App.TaskList (line 87, column 16 - line 90, column 27): " + [ v.constructor.name ]);
  };
...
(function($PS) {
  ...
  var taskList = function (selector) {
      return Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.selectElement(selector))(function (element) {
          if (element instanceof Data_Maybe.Just) {
              return Data_Functor["void"](Effect_Aff.functorAff)(Halogen_VDom_Driver.runUI(App_TaskList.component)(Data_Unit.unit)(element.value0));
          };
          if (element instanceof Data_Maybe.Nothing) {
              return Control_Applicative.pure(Effect_Aff.applicativeAff)(Data_Unit.unit);
          };
          throw new Error("Failed pattern match at Main (line 16, column 5 - line 18, column 27): " + [ element.constructor.name ]);
      }));
  };
  var main = taskList("#psTaskList");
